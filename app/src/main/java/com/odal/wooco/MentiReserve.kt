...
class MentiReserve : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("coachName_MentiReserve", "coachName2 : $coach_receiverName")
                                ...
                                if (isChange && reserveId != null) {
                                    ...
                                    reserveInfoRef.child(reserveId).updateChildren(dataMap)
                                        .addOnSuccessListener {
                                            ...
                                            createClassRooms(mentiUid, coach_receiverUid, mentiName, coach_receiverName)
    ...
    private fun createClassRooms(mentiUid: String, coachUid: String, mentiName: String, coachName: String) {
        val senderRoom = coachUid + mentiUid
        val receiverRoom = mentiUid + coachUid
