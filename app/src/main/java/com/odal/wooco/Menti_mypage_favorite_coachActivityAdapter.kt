...
class Menti_mypage_favorite_coachActivityAdapter(private val itemList: List<Item>) : RecyclerView.Adapter<Menti_mypage_favorite_coachActivityAdapter.ItemViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.menti_mypage_favorite_coach_item, parent, false)
